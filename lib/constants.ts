...
export const CONTENT_RULES = {
  ...
  SMS_INSTANT_MESSENGER_ONLY: true,
} as const;
...
export const BUCKETS = [
  ...
  },
  {
    ...
    packages: ["Option Mantra", "Index Options", "HNI Options"],
    risk: "Low – High",
...
export const PACKAGES = {
  ...
  futures: [
    ...
    },
    {
      ...
      features: [
        ...
        "Instant delivery via SMS & messaging channels",
      ],
    ...
    },
    {
      ...
      targets: "3 Targets + Strict Stop-Loss",
      maxOpenPositions: "2 at a time",
      delivery: ["SMS", "Instant Messenger", "Direct Analyst Call"],
      features: [
  ...
  options: [
    ...
    },
    {
      ...
      targets: "3 Targets + Strict Stop-Loss",
      maxOpenPositions: "2 at a time",
      delivery: ["SMS", "Instant Messenger", "Priority Channel"],
      features: [
  ...
  commodity: [
    ...
    },
    {
      ...
      targets: "3 Targets + Strict Stop-Loss",
      maxOpenPositions: "2 at a time",
      delivery: ["SMS", "Instant Messenger", "Direct Support"],
      features: [
    ...
    },
    {
      ...
      delivery: ["SMS", "Instant Messenger", "Priority Analyst Desk"],
      features: [
...
export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "All official research calls are delivered strictly via SMS and registered Instant Messaging channels directly to your verified mobile number. We do NOT operate or distribute calls via any Telegram channels or unofficial groups.",
  },
  {
